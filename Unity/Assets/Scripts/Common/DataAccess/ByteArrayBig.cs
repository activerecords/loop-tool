...
{
	public class ByteArrayBig : ByteArray
	{
		...
		public override Int32 ReadInt24()
		{
			...
			dataArray4[0] = 0x00;
			dataArray4[1] = dataArray3[2];
			dataArray4[2] = dataArray3[1];
			dataArray4[3] = dataArray3[0];
			...
			/*
			byte[] readData = dataArray3;
			byte[] tempData = 
			{
				0x00, readData[2], readData[1], readData[0]
			};
		...
		public byte ReadBit()
		{
			byte lData = ( byte )( ( stream.ReadByte() >> ( 7 - ( PositionBit & 7 ) ) ) & 0x01 );
		...
		public override Byte ReadBitsAsByte( int aLength )
		{
			byte lData = 0x00;
		...
		public override UInt16 ReadBitsAsUInt16( int aLength )
		{
			UInt16 lData = 0x00;
			...
			{
				lData <<= 1;
				lData |= ( UInt16 )ReadBit();
			}
			
			return lData;
		}
		
		public override UInt32 ReadBitsAsUInt32( int aLength )
		{
			UInt32 lData = 0x00;
