...
namespace Curan.Common.FormalizedData.File.Riff.Wave
{
	public class RiffChunkSmpl : RiffChunk
	{
		...
		public RiffChunkSmpl( UInt32 aManufacturer, UInt32 aProduct, UInt32 aSamplePeriod, UInt32 aMidiUnityNote, UInt32 aMidiPitchFraction, UInt32 aSmpteFormat, UInt32 aSmpteOffset, UInt32 aSampleLoops, UInt32 aSamplerData, List<SampleLoop> aSampleLoopList )
