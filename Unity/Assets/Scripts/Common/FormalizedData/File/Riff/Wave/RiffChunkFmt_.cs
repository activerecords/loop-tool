...
namespace Curan.Common.FormalizedData.File.Riff.Wave
{
	public class RiffChunkFmt_ : RiffChunk
	{
		...
		public RiffChunkFmt_( FormatTag aTag, UInt16 aChannels, UInt32 aSamplesPerSec, UInt32 aAverageBytesPerSec, UInt16 aBlockAlign, UInt16 aBitsPerSample, RiffChunkList aParent )
