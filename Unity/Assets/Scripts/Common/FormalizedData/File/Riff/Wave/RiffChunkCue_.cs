...
{
	public class RiffChunkCue_ : RiffChunk
	{
		...
		public RiffChunkCue_( string aId, UInt32 aSize, ByteArray aByteArray, RiffChunkList aParent )
		...
		public RiffChunkCue_( List<CuePoint> aCuePoints )
