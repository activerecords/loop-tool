...
namespace Curan.Common.FormalizedData.File.Riff.Sfbk
{
	public class RiffChunkShdr : RiffChunk
	{
		...
		public RiffChunkShdr( string aId, UInt32 aSize, ByteArray aByteArray, RiffChunkList aParent )
	...
	public class ShdrData
	{
		...
		public ShdrData( ByteArray aByteArray, List<string> aInformationList )
		{
			...
			{
				Logger.LogWarning( sampleName + "/" + "Not Mono Sample:" + sampleType );
			}
		}
	}
}
