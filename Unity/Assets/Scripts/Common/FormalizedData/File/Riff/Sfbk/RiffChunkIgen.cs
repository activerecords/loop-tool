...
{
	public class RiffChunkIgen : RiffChunk
	{
		public const string ID = "igen";

		public readonly IgenData[] igenDataArray;

		public RiffChunkIgen( string aId, UInt32 aSize, ByteArray aByteArray, RiffChunkList aParent )
	...
	public class IgenData
	{
		public readonly SFGenerator genOper;
		public readonly Generator amount;

		public IgenData( ByteArray aByteArray, List<string> aInformationList )
		{
			...
			case SFGenerator.OverridingRootKey:
				...
				Logger.LogNormal( "Overriding Root Key:" + overridingRootKey );
				break;
