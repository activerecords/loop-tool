...
namespace Curan.Common.Struct
{
	...
	public class SoundTime
	{
		...
		public int MilliSecond
		{
			get
			{
				return (int)(sample / sampleRate % 1.0d * 1000);
			}
		}
		...
		public int Second
		{
			get
			{
				return (int)sample / sampleRate % 60;
			}
		}
		...
		public int Hour
		{
			get
			{
				return (int)sample / sampleRate / 3600;
			}
		}

		public string MMSSmmm
		{
			get
			{
				return Minute.ToString ("D2") + ":" + Second.ToString ("D2") + "." + MilliSecond.ToString ("D3");
			}
		}
	}
}
