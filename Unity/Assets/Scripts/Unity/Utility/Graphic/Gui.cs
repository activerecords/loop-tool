...
namespace Unity.Function.Graphic
{
    public static class Gui
    {
		...
		public static void DrawSeekBar( Rect aRect, GUIStyle aStyle, float aPositionLoopStart, float aPositionLoopEnd, float aPositionCurrent )
		{
			...
			{
				DrawSeekBarPartition( camera, aRect, aStyle, aStyle.onNormal, 0.0f, aPositionCurrent );
				DrawSeekBarPartition( camera, aRect, aStyle, aStyle.normal, aPositionCurrent, aPositionLoopStart );
				DrawSeekBarPartition( camera, aRect, aStyle, aStyle.active, aPositionLoopStart, aPositionLoopEnd );
				DrawSeekBarPartition( camera, aRect, aStyle, aStyle.normal, aPositionLoopEnd, 1.0f );
			}
			else if( aPositionCurrent == aPositionLoopStart )
			{
				DrawSeekBarPartition( camera, aRect, aStyle, aStyle.onNormal, 0.0f, aPositionCurrent );
				DrawSeekBarPartition( camera, aRect, aStyle, aStyle.active, aPositionCurrent, aPositionLoopEnd );
				DrawSeekBarPartition( camera, aRect, aStyle, aStyle.normal, aPositionLoopEnd, 1.0f );
			}
			else if( aPositionCurrent < aPositionLoopEnd )
			{
				DrawSeekBarPartition( camera, aRect, aStyle, aStyle.onNormal, 0.0f, aPositionLoopStart );
				DrawSeekBarPartition( camera, aRect, aStyle, aStyle.onActive, aPositionLoopStart, aPositionCurrent );
				DrawSeekBarPartition( camera, aRect, aStyle, aStyle.active, aPositionCurrent, aPositionLoopEnd );
				DrawSeekBarPartition( camera, aRect, aStyle, aStyle.normal, aPositionLoopEnd, 1.0f );
			}
			else if( aPositionCurrent == aPositionLoopEnd )
			...
			{
				DrawSeekBarPartition( camera, aRect, aStyle, aStyle.onNormal, 0.0f, aPositionLoopStart );
				DrawSeekBarPartition( camera, aRect, aStyle, aStyle.onActive, aPositionLoopStart, aPositionLoopEnd );
				DrawSeekBarPartition( camera, aRect, aStyle, aStyle.onNormal, aPositionLoopEnd, aPositionCurrent );
				DrawSeekBarPartition( camera, aRect, aStyle, aStyle.normal, aPositionCurrent, 1.0f );
			}
		}
