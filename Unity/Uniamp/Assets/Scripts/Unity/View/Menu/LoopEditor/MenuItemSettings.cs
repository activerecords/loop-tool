...
namespace Unity.View.LoopEditor
{
	...
	{
		private ApplicationLoopEditor applicationLoopTool;
		private DialogSettingsLoop dialogSettingsLoop;
		private bool isShow;

		public MenuItemSettings( string aTitle, string aFilePathLanguage, ApplicationLoopEditor aApplicationLoopTool )
			: base( aTitle )
		{
