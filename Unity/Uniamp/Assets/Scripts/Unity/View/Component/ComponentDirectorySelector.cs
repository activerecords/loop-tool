...
namespace Unity.View
{
	public class ComponentDirectorySelector : IView
	{
		...
		private void DisplayDirectoryTree()
		{
			...
			GUILayout.BeginVertical( GuiStyleSet.StyleList.box );
			{
				positionScrollDirectory = GUILayout.BeginScrollView( positionScrollDirectory, false, false, GuiStyleSet.StyleScrollbar.horizontalbar, GuiStyleSet.StyleScrollbar.verticalbar );
				{
